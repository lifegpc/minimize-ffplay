...
curl "https://github.com/lifegpc/static-mingw-w64-gnutls/releases/download/3.7.1-1/mingw-w64-i686-gnutls-3.7.1-1-any.pkg.tar.zst" -o $GNUTLS -L || exit 1
...
curl "https://github.com/lifegpc/static-mingw-w64-harfbuzz/releases/download/2.8.1-1/mingw-w64-i686-harfbuzz-2.8.1-1-any.pkg.tar.zst" -o $HARFBUZZ -L || exit 1
...
curl "https://github.com/lifegpc/static-mingw-w64-libass/releases/download/0.15.1-1/mingw-w64-i686-libass-0.15.1-1-any.pkg.tar.zst" -o $LIBASS -L || exit 1
